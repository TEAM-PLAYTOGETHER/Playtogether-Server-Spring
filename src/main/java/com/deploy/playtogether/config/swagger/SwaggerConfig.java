package com.deploy.playtogether.config.swagger;
...
public class SwaggerConfig {
    private static final String API_NAME = "PlayTogether Project API";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Lee Je June", "https://www.instagram.com/leejejune_/", "dlwpwns01@naver.com"))
                .build();
    }
